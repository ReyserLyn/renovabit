...
import {
	...
	TooltipContent,
	TooltipTrigger,
} from "@renovabit/ui/components/ui/tooltip";
...
function SidebarTrigger({
	...
	return (
		<Button
			...
			{...props}
		>
			<HugeiconsIcon icon={SidebarLeftIcon} color="currentColor" />
...
function SidebarGroupLabel({
	...
	return useRender({
		...
		props: mergeProps<"div">(
			{
				className: cn(
					"text-sidebar-foreground/70 ring-sidebar-ring h-8 rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-5 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 flex shrink-0 items-center outline-hidden [&>svg]:shrink-0",
					className,
				),
			},
			props,
...
function SidebarMenuButton({
	...
	return (
		<Tooltip>
			<TooltipTrigger className="block w-full">{comp}</TooltipTrigger>
			<TooltipContent
				side="right"
				align="center"
