    ...
    <>
      <div>
        <div className="relative" aria-hidden="true">
          ...
          <div className="relative text-2xl font-bold text-center text-primary drop-shadow-2xl md:text-3xl lg:text-4xl lg:text-secondary dark:lg:text-primary xl:text-5xl 2xl:text-6xl [@media(max-height:750px)]:text-primary [@media(max-height:750px)]:drop-shadow-none">
            Servicio Técnico
          </div>
        </div>
